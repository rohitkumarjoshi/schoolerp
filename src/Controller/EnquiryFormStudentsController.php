...
class EnquiryFormStudentsController extends AppController
{
    ...
    public function index()
    {
        ...
        $enquiryFormStudents = $this->EnquiryFormStudents->find()->where(['EnquiryFormStudents.session_year_id'=>$session_year_id,'enquiry_no >'=>0,'EnquiryFormStudents.is_deleted'=>0])->contain(['Genders','Mediums','StudentClasses','Streams']);
    ...
    public function view($id = null)
    {
        ...
        $this->set(compact('enquiryFormStudent','enquiryStatuses'));
    }
