        ...
        <div class="box box-primary">
            <div class="box-header with-border" >
                ...
                <div class="box-tools pull-right">
                  <?= $this->Html->link('Student Edit',['controller'=>'Students','action'=>'editStudent',$student_id,'FeeReceipts','admissionFee']) ?>
                </div>
            </div>
            <div class="box-body">
            <?= $this->Form->create($feeReceipt,['class'=>'FormSubmit','id'=>'ServiceForm']) ?>
                <?= $this->Form->control('fee_category_id',['label' => false,'type'=>'hidden','value'=>3])?>
                        ...
                        foreach ($FeeData as $FeeDatas) {
                            ...
                            $feeAmount=@$FeeDatas->fee_type_master_rows[0]->amount;
                                if($totSubmitted<$feeAmount){
                                    $this->Form->control('fee_type_master_rows['.$x.'][fee_type_master_row_id]',['label' => false,'type'=>'hidden','value'=>$FeeDatas->fee_type_master_rows[0]->id]);
                                }
                            $x++;
                        }
                        echo"</tr>";
                    ...
                    <tbody>
                        ...
                        $SubmittedAmount = 0;
                          foreach ($FeeData as $FeeDatas) {
                            ...
                            echo "
                                <td style='text-align:left !important'><lable ><strong>Total Amount: </stromg>".$feeAmount."</lable>".
            ...
            <tbody>
                ...
                foreach ($SubmittedFee as $Submittedlist) {
                    ...
                    <tr>
                        ...
                        <td> 
                           <?= $this->Html->link('<i class="fa fa-print"></i>',['controller'=>'FeeReceipts','action'=>'receiptPrint','FeeReceipts','admissionFee',$receipt_id,$student_info_id],['escape'=>false,'class'=>'btn btn-primary btn-xs']) ?>
...
<div id="deletemodal<?php echo $Submittedlist->id; ?>" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md" >
        <?= $this->Form->create('from',['url'=>['action'=>'delete','admissionFee',$receipt_id,$student_info_id]]) ?>
            <div class="modal-content">
              <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        $('.' + isClass).each(function(){
            ...
            if(row == 1 && column == 1){
                ...
                if(amount==0)
                {
                    ...
                    obj_cur.closest('th').append('<span style=font-weight:bolder;> Paid</span>');
