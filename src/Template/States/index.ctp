	...
	<div class="col-md-6">
		<div class="box box-primary">
			<div class="box-header with-border" >
				<?php if(!empty($id)){ ?>
					<i class="fa fa-pencil-square-o fas" style="float:none !important;"></i> <label > Edit State </label>
				<?php }else{ ?>
					<i class="fa fa-hand-o-right fas" style="float:none !important;"></i> <label> Add State </label>
				<?php } ?>
			</div>
			<div class="box-body">
				<div class="form-group">	
					<?= $this->Form->create($state,['id'=>'ServiceForm']) ?>
					<div class="row">
						<div class="col-md-4">
					...
					<tbody>
						...
						<tr>
							...
							<td class="actions" align="center">
								<?= $this->Html->link(__('<i class="fa fa-pencil-square-o"></i> '), ['action' => 'index', $EncryptingDecrypting->encryptData($State->id)],['class'=>'btn btn-info btn-xs','escape'=>false, 'data-widget'=>'Edit State', 'data-toggle'=>'tooltip', 'data-original-title'=>'Edit State']) ?>
							</td>
						</tr>
					<?php $i++; endforeach; ?>
					</tbody>
